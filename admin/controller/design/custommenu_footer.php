...
class ControllerDesignCustomMenuFooter extends Controller {
    ...
    public function index() {
		...
		if (isset($this->request->post['configcustommenu_custommenu_footer'])) {
			$data['configcustommenu_custommenu_footer'] = $this->request->post['configcustommenu_custommenu_footer'];
		} else {
			$data['configcustommenu_custommenu_footer'] = $this->config->get('configcustommenu_custommenu_footer');
		}
